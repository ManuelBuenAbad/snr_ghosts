...
def BlackHoleSpins(ax,C,label_position,whichfile='Mehta',fs=20,col='k',alpha=0.4,\
    ...
    # arxiv: 2011.11646
    dat = loadtxt(os.path.join(rootdir, 'limit_data/fa/BlackHoleSpins_'+whichfile+'.txt'))
    dat[:,1] = dat[:,1]*C
    if PlotLine:
...
class AxionPhoton():
    ...
    def ADMX(ax,col=[0.8, 0.0, 0.0],projection=False,fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ADMX2018.txt"))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0.1)
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ADMX2019_1.txt"))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0.1)
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ADMX2019_2.txt"))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0.1)
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ADMX_Sidecar.txt"))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0.1)


        if projection:
            # ADMX arXiv[1804.05750]
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/ADMX_Projected.txt"))
    ...
    def RBF_UF(ax,col ='darkred',fs=13,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs2 = 1.0
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/RBF_UF_Haloscopes.txt"))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0.1)
    ...
    def HAYSTAC(ax,col=[0.88, 0.07, 0.37],fs=13,RescaleByMass=False,projection=True,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            zo = 0
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/HAYSTAC.txt"))
        dat2 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/HAYSTAC_2020.txt"))
        ...
        if rs1==0:
            ...
            if text_on:
                if projection==False:
                    plt.text(text_shift[0]*2.1e-5,text_shift[1]*5e-13,r'{\bf HAYSTAC}',fontsize=fs,color=col,rotation=-90,ha='left',va='top',clip_on=True)
        else:
    ...
    def CAPP(ax,col=[1, 0.1, 0.37],fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs2 = 1.0
            zo = 0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/CAPP-1.txt"))
        dat2 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/CAPP-2.txt"))
        dat3 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/CAPP-3.txt"))
        if rs1==0:
            plt.plot([dat[0,0],dat[0,0]],[dat[0,1]/(rs1*2e-10*dat[0,0]+rs2),y2/(rs1*2e-10*dat[0,0]+rs2)],color=col,zorder=zo,lw=3)
    ...
    def QUAX(ax,col='crimson',fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        dat2 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/QUAX2.txt"))
    ...
    def ABRACADABRA(ax,col=[0.83, 0.07, 0.37],fs=15,projection=False,RescaleByMass=False,text_on=True,lw=1,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs2 = 1.0
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ABRACADABRA.txt"))
        n = shape(dat)[0]
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ABRACADABRA_run2.txt"))
        n = shape(dat)[0]
        ...
        if projection:
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/ABRACADABRA.txt"))
            plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=1.5,color=col,zorder=0)
            plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0,alpha=0.1)
            if text_on:
                if rs1==0:
    ...
    def DMRadio(ax,col=[0.83, 0.07, 0.37],fs=23,text_on=True,RescaleByMass=False,lw=2,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionPhoton/Projections/DMRadio.txt'))
    ...
    def ORGAN(ax,col=[0.8, 0.0, 0.0],projection=False,fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs2 = 1.0
            zo = 0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ORGAN.txt"))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=col,facecolor=col,zorder=0.1,lw=2)

        if projection:
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/ORGAN_Projected.txt"))
            plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=1.5,color=col,zorder=0)
    ...
    def RADES(ax,col='blueviolet',fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            zo = 0
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/RADES.txt"))
    ...
    def MADMAX(ax,col='darkred',fs=18,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/MADMAX.txt"))
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=1.5,color=col,zorder=0)
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0,alpha=0.2)
        if text_on:
            if rs1==0:
    ...
    def ALPHA(ax,col='darkred',fs=18,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/ALPHA.txt"))
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=2,color=col,zorder=0)
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0,alpha=0.2)
        if text_on:
            if rs1==0:
    ...
    def KLASH(ax,col=[0.6, 0.1, 0.2],fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/KLASH.txt"))
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=1.5,color=col,zorder=0)
    ...
    def BRASS(ax,col=[0.5, 0.1, 0.2],fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/BRASS.txt"))
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=1.5,color=col,zorder=0)
    ...
    def TOORAD(ax,col=[0.8, 0.1, 0.2],fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/TOORAD2.txt"))
        dat[:,0] *= 1e-3
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=1.5,color=col,zorder=0)
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,facecolor=col,zorder=0,alpha=0.1)
        if text_on:
    ...
    def LAMPOST(ax,col=[0.8, 0.1, 0.2],fs=15,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/LAMPOST.txt",delimiter=','))
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'-',linewidth=1.5,color=col,zorder=0)
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,facecolor=col,zorder=0,alpha=0.1)
        if text_on:
            if rs1==0:
    ...
    def DANCE(ax,col=[0.8, 0.1, 0.2],fs=15,text_on=True,text_pos=[1.7e-12,2e-13]):
        ...
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/DANCE.txt"))
    ...
    def aLIGO(ax,col=[0.8, 0.1, 0.2],fs=15,text_on=True,text_pos=[0.2e-9,0.35e-13]):
        ...
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/aLIGO.txt"))
        plt.plot(dat[:,0],dat[:,1],'-',linewidth=1.5,color=col,zorder=0)
        plt.fill_between(dat[:,0],dat[:,1],y2=y2,facecolor=col,zorder=0,alpha=0.1)
        if text_on:
    ...
    def ADBC(ax,col=[0.8, 0.1, 0.2],fs=15,text_on=True,text_pos=[1e-11,1.3e-12],rotation=26):
        ...
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/ADBC.txt"))
        plt.plot(dat[:,0],dat[:,1],'-',linewidth=1.5,color=col,zorder=0)
        plt.fill_between(dat[:,0],dat[:,1],y2=y2,facecolor=col,zorder=0,alpha=0.1)
        if text_on:
    ...
    def SHAFT(ax,col='red',fs=16,text_on=True,lw=1,text_pos=[0.8e-10,3e-10],rotation=0,zorder=1.8):
        ...
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/SHAFT.txt"))
        n = shape(dat)[0]
    ...
    def UPLOAD(ax,col='tomato',fs=16,text_on=False):
        ...
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/UPLOAD.txt"))
        n = shape(dat)[0]
        x = dat[arange(0,n,2),0]
        y = dat[arange(0,n,2),1]
        y[-1] = y2
    ...
    def ADMX_SLIC(ax,col='crimson',fs=12,RescaleByMass=False,text_on=True,text_shift=[1,1],zorder=1):
        ...
        if RescaleByMass:
            ...
            zo = zorder
        y2 = ax.get_ylim()[1]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/ADMX_SLIC.txt"))
        x = mean(dat[:,0])
        y = amin(dat[:,1])
        if rs1==0:
    ...
    def ALPS(ax,projection=True,col=[0.8, 0.25, 0.33],fs=15,RescaleByMass=False,text_on=True,lw_proj=1.5,lsty_proj='-',col_proj='k',text_shift_x=1,text_shift_y=1):
        ...
        if projection:
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/ALPS-II.txt"))
    ...
    def OSQAR(ax,text_label=r'{\bf OSQAR}',text_pos=[1e-5,3e-8],col=[0.6, 0.2, 0.25],text_col='w',fs=17,zorder=1.52,text_on=True,edgealpha=1,lw=2):
        # PVLAS arXiv:[]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/OSQAR.txt"))
    ...
    def PVLAS(ax,text_label=r'{\bf PVLAS}',text_pos=[2e-3,9e-8],col=[0.4, 0.2, 0.2],text_col='w',fs=17,zorder=1.51,text_on=True,edgealpha=1,rotation=45,lw=2):
        # PVLAS arXiv:[]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/PVLAS.txt"))
    ...
    def CROWS(ax,text_label=r'{\bf CROWS}',text_pos=[1e-7,2.5e-7],col=[0.7, 0.2, 0.2],text_col='w',fs=17,zorder=1.54,text_on=True,edgealpha=1,lw=2):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/CROWS.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on,edgealpha=edgealpha,lw=lw)
        return
    ...
    def Helioscopes(ax,col=[0.5, 0.0, 0.13],fs=25,projection=False,RescaleByMass=False,text_on=True, text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/CAST_highm.txt"))
        ...
        if text_on==True:
            if rs1==0:
                plt.text(1e-5*text_shift[0],1.5e-10*text_shift[1],r'{\bf CAST}',fontsize=fs+4,color='w',rotation=0,ha='center',va='top',clip_on=True)
            else:
        ...
        if projection:
            ...
            IAXO_col = 'purple'
            IAXO = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/IAXO.txt"))
    ...
    def FermiSNe(ax,text_label=r'{\bf Fermi-SNe}',text_pos=[1.2e-12,0.51e-10],col='ForestGreen',text_col='w',fs=12,zorder=0.25,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/SNe-gamma.txt"))
    ...
    def DSNALP(ax,text_label=r'{\bf DSNALP}',text_pos=[1.2e-12,1.2e-10],col=[0.0, 0.62, 0.3],text_col='w',fs=12,zorder=0.25,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/DSNALP.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on)
        return
    ...
    def SN1987A_gamma(ax,text_label=r'{\bf SN1987A}',text_pos=[6e-11,0.4e-11],col='#067034',text_col='#067034',fs=15,zorder=0.21,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/SN1987A_gamma.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on)
        return
    ...
    def Hydra(ax,text_label=r'{\bf Hydra}',text_pos=[1.2e-12,2e-11],col=[0.24, 0.71, 0.54],text_col='w',fs=13,zorder=0.23,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/HYDRA_A.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on)
        return
    ...
    def Mrk421(ax,text_label=r'{\bf Mrk 421}',text_pos=[3e-9,6e-11],col=[0.4, 0.6, 0.1],text_col='w',fs=12,zorder=0.26,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Mrk421.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on)
        return
    ...
    def Chandra(ax,text_label=r'{\bf Chandra}',text_pos=[1.01e-11,1.5e-12],col= [0.0, 0.3, 0.24],text_col=[0.0, 0.3, 0.24],fs=15,zorder=0.1,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Chandra.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on)
        return
    ...
    def Fermi(ax,text_label=r'{\bf Fermi}',text_pos=[4.02e-10,1.2e-11],col=[0.0, 0.42, 0.24],text_col='w',fs=15,zorder=0.24,text_on=True):
        ...
        Fermi1 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Fermi1.txt"))
        Fermi2 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Fermi2.txt"))
        ...
        Fermi1 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Fermi_bound.txt"))
        Fermi2 = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Fermi_hole.txt"))
    ...
    def StarClusters(ax,text_pos=[2.2e-11,2.7e-11],col= [0.2, 0.54, 0.01],text_col='w',fs=13,zorder=0.22,rotation=45,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Xray-SuperStarClusters.txt"))
    ...
    def Fermi_GalacticSN(ax,text_label=r'{\bf Fermi SN}',text_pos=[1e-9,5e-13],col=[0.0, 0.42, 0.24],text_col=[0.0, 0.42, 0.24],fs=15,zorder=0.1,text_on=True,rotation=43,lw=1.5,facealpha=0.2):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/FermiSN.txt"))
    ...
    def MUSE(ax,text_label=r'{\bf MUSE}',text_pos=[1.5,0.7e-12],col=[0.09, 0.45, 0.27],text_col=[0.09, 0.45, 0.27],fs=15,zorder=0.2,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Telescopes_MUSE.txt"))
    ...
    def VIMOS(ax,text_label=r'{\bf VIMOS}',text_pos=[15,1e-11],col=[0.09, 0.6, 0.27],text_col=[0.09, 0.6, 0.27],fs=15,zorder=0.2,text_on=True):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Telescopes_VIMOS.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,edgecolor=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on,rotation=-90,lw=0.0,edgealpha=0)
        return
    ...
    def THESEUS(ax,text_label=r'{\bf THESEUS}',text_pos=[8e2,0.8e-17],col=[0.03, 0.57, 0.82],edgecolor=[0.03, 0.57, 0.82],text_col=[0.03, 0.57, 0.82],fs=17,zorder=0.01,text_on=True,lw=2,facealpha=0.1):
        # THESEUS 2008.08306
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/THESEUS.txt"))
    ...
    def eROSITA(ax,text_label=r'{\bf eROSITA}',text_pos=[2e3,0.3e-18],col=[0.03, 0.57, 0.82],edgecolor=[0.03, 0.57, 0.82],text_col=[0.03, 0.57, 0.82],fs=17,zorder=0.01,text_on=True,lw=2,facealpha=0.1):
        # eROSITA 2103.13241
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/Projections/eROSITA.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,edgecolor=edgecolor,edgealpha=1,fs=fs,zorder=zorder,text_on=text_on,lw=lw,ha='right',facealpha=facealpha)
    ...
    def Cosmology(ax,fs=30,text_on=True):
        ...
        # Ionisation fraction
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/x_ion.txt"))
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/BBN_Neff.txt"))
    ...
    def HorizontalBranch(ax,text_label=r'{\bf Horizontal branch}',text_pos=[1.4e0,1.5e-10],col=[0.0, 0.66, 0.42],text_col='w',fs=23,zorder=1,text_on=True,lw=2):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/HorizontalBranch.txt"))
    ...
    def SolarNu(ax,text_label=r'{\bf Solar} $\nu$',text_pos=[1e1,3e-9],col='seagreen',text_col='w',fs=33,zorder=1,text_on=True,lw=2):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/SolarNu.txt"))
        FilledLimit(ax,dat,text_label,text_pos=text_pos,col=col,text_col=text_col,fs=fs,zorder=zorder,text_on=text_on,lw=lw,va='center')
        return
    ...
    def SN1987A_decay(ax,text_label=r'{\bf Solar} $\nu$',text_pos=[1e1,3e-9],col='#067034',text_col='w',fs=21,zorder=0.1,text_on=True,lw=2,rotation=-60):
        ...
        SN = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/SN1987A_2019.txt"))
        plt.fill_between(SN[:,0],SN[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
        # SN1987A-decay arXiv:[1702.02964]
        SN = loadtxt(os.path.join(rootdir, "limit_data/AxionPhoton/SN1987A_decay.txt"))
        plt.fill_between(SN[:,0],SN[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
        if text_on:
    ...
    def NeutronStars(ax,col=[0.1, 0.5, 0.2],fs=17,RescaleByMass=False,text_on=True,text_shift=[1,1]):
        ...
        if RescaleByMass:
            ...
            rs1 = 0.0
            rs2 = 1.0
        dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionPhoton/NeutronStars_GreenBank.txt'))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0.1)
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'k-',alpha=0.5,lw=0.5,zorder=0)

        dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionPhoton/NeutronStars_VLA.txt'))
        plt.fill_between(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),y2=y2,edgecolor=None,facecolor=col,zorder=0.1)
        plt.plot(dat[:,0],dat[:,1]/(rs1*2e-10*dat[:,0]+rs2),'k-',alpha=0.5,lw=0.5,zorder=0)

        dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionPhoton/NeutronStars_Battye.txt'))
        ...
        if text_on:
            if rs1==0:
                plt.text(text_shift[0]*3e-6,text_shift[1]*0.8e-10,r'{\bf Neutron stars}',fontsize=fs,color=array(col)/1.5,ha='left')
            else:
...
class AxionElectron():
    ...
    def XENON1T(ax,col='crimson',fs=19,text_on=True,zorder=0.51,text_shift=[1,1],**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/XENON1T_DM_S2.txt"))
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/XENON1T_DM_S1S2.txt"))
        plt.plot(dat[:,0],dat[:,1],'k-',alpha=1,zorder=zorder,lw=2)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
        if text_on:
    ...
    def SolarBasin(ax,col='royalblue',fs=20,text_on=True,text_shift=[1,1],zorder=0.6,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/XENON1T_S2_SolarAxionBasin.txt"))
        plt.plot(dat[:,0],dat[:,1],'k-',alpha=1,zorder=zorder,lw=2)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
        if text_on:
    ...
    def LUX(ax,col='darkred',fs=30,text_on=True,text_pos=[0.2e-8,6e-12],zorder=0.52,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/LUX.txt"))
        plt.plot(dat[:,0],dat[:,1],'k-',alpha=1,zorder=zorder,lw=2)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
        if text_on:
...
#         plt.fill_between(dat[:,0],dat[:,1],y2=y2,edgecolor=None,facecolor=col,zorder=0.53)
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/PandaX.txt"))
        plt.plot(dat[:,0],dat[:,1],'k-',alpha=1,zorder=zorder,lw=2)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
        if text_on:
    ...
    def EDELWEISS(ax,col='darkred',projection=False,fs=15,text_on=True,text_pos=[9e0,7e-13],zorder=0.57,rotation=0,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/EDELWEISS.txt"))
        plt.plot(dat[:,0],dat[:,1],'k-',alpha=1,zorder=zorder,lw=2)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
        if projection:
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/Projections/EDELWEISS.txt"))
    ...
    def SuperCDMS(ax,col='maroon',fs=20,text_on=True,text_pos=[1.7e1,2.7e-11],zorder=0.58,rotation=-82,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/SuperCDMS.txt"))
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
    ...
    def DARWIN(ax,col='brown',fs=20,text_on=True,text_pos=[0.3e3,2e-14],zorder=0.1,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/Projections/DARWIN.txt"))
    ...
    def LZ(ax,col='crimson',fs=20,text_on=True,text_pos=[1.5e4,2e-14],zorder=0.1,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/Projections/LZ.txt"))
        plt.plot(dat[:,0],dat[:,1],'--',color=col,alpha=1.0,zorder=zorder,lw=3)
        if text_on:
    ...
    def Semiconductors(ax,col='purple',fs=15,text_on=True,text_pos=[1e0,2.5e-12],rotation=-80,zorder=0.51,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/Projections/SemiconductorAbsorption.txt"))
        plt.plot(dat[:,0],dat[:,1],'--',color=col,alpha=1.0,zorder=zorder,lw=3)
        if text_on:
    ...
    def Magnon(ax,col='rebeccapurple',fs=20,text_on=True,text_pos=[2e-6,1e-14],zorder=0.51,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/Projections/Magnon.txt"))
    ...
    def MagnonScan(ax,col='mediumvioletred',fs=20,text_on=True,text_shift=[1,1],zorder=0.5,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/Projections/MagnonScan.txt"))
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,color=col,alpha=0.4,zorder=zorder)
        plt.plot(dat[:,0],dat[:,1],'--',color=col,alpha=1.0,zorder=zorder,lw=3)
        if text_on:
    ...
    def RedGiants(ax,col=[0.0, 0.66, 0.42],text_pos=[0.2e-8,2e-13],text_on=True,zorder=0.5,fs=30,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/RedGiants.txt"))
    ...
    def SolarNu(ax,col='seagreen',text_pos=[0.2e-8,3.8e-11],text_on=True,zorder=0.7,fs=30,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/SolarNu.txt"))
        plt.plot(dat[:,0],dat[:,1],color='k',alpha=1,zorder=zorder,lw=2)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e0,edgecolor=None,facecolor=col,zorder=zorder)
    ...
    def WhiteDwarfHint(ax,col='k',text_pos=[1e-7,1e-13],facealpha=0.3,zorder=1.0,text_on=True,fs=20,**kwargs):
        ...
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionElectron/WDhint.txt"))
...
class AxionNeutron():
    ...
    def OldComagnetometers(ax,col=[0.75, 0.2, 0.2],fs=20,projection=True):
        ...
        y2 = ax.get_ylim()[1]
        zo = 0.3
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/OldComagnetometers.txt"))
        ...
        if projection:
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/Projections/FutureComagnetometers.txt"))
            dat[:,1] *= 2*AxionNeutron.m_n
    ...
    def UltracoldNeutronsAndMercury(ax,col=[0.5, 0.0, 0.13],fs=20,projection=True):
        ...
        y2 = ax.get_ylim()[1]
        zo = 1
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/UltracoldNeutronsAndMercury.txt"))
        dat[:,1] *= 2*AxionNeutron.m_n
    ...
    def NASDUCK(ax,col=[0.77, 0.1, 0.13],fs=20,projection=True):
        y2 = ax.get_ylim()[1]
        zo = 1
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/NASDUCK.txt"))
        dat[:,1] *= 2*AxionNeutron.m_n
    ...
    class CASPEr():
        def ZULF(ax,col=[0.6, 0.1, 0.1],fs=20,projection=True):
            ...
            y2 = ax.get_ylim()[1]
            zo = 1
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/CASPEr_ZULF.txt"))
            dat[:,1] *= 2*AxionNeutron.m_n
            ...
            if projection:
                dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/Projections/CASPEr_ZULF.txt"))
                dat[:,1] *= 2*AxionNeutron.m_n
        ...
        def Comagnetometer(ax,col='darkred',fs=20,projection=True):
            ...
            y2 = ax.get_ylim()[1]
            zo = 1.5
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/CASPEr_Comagnetometer.txt"))
            dat[:,1] *= 2*AxionNeutron.m_n
        ...
        def wind(ax,col='red',fs=20,projection=True):
            ...
            y2 = ax.get_ylim()[1]
            zo = -1
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/Projections/CASPEr_wind.txt"))
            dat[:,1] *= 2*AxionNeutron.m_n
    ...
    def LabExperiments(ax,projection=True,fs=20):
        ...
        zo = 0.2
        col = [0.4, 0.2, 0.2]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/K-3He_Comagnetometer.txt"))
        plt.plot(dat[:,0],dat[:,1],'-',color='k',alpha=1,zorder=zo,lw=3)
        plt.fill_between(dat[:,0],dat[:,1],y2=y2,edgecolor=None,facecolor=col,zorder=zo)
        ...
        zo = 0.21
        col = [0.2, 0.25, 0.25]
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/TorsionBalance.txt"))
        ...
        if projection:
            ...
            zo = -1
            col = 'crimson'
            dat = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/Projections/StorageRing.txt"))
            dat[:,1] *= 2*AxionNeutron.m_n
            plt.plot(dat[:,0],dat[:,1],'--',color=col,alpha=1.0,zorder=zo,lw=3)
    ...
    def StellarBounds(ax,fs=30):
        ...
        SN = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/SN1987A.txt"))
        ...
        SN = loadtxt(os.path.join(rootdir, "limit_data/AxionNeutron/NeutronStars.txt"))
        SN[:,1] *= 2*AxionNeutron.m_n
...
class AxionProton():
    ...
    def NASDUCK(ax,col=[0.77, 0.1, 0.13],fs=20,projection=True):
        y2 = ax.get_ylim()[1]
        zo = 1
        dat = loadtxt(os.path.join(rootdir, "limit_data/AxionProton/NASDUCK.txt"))
    ...
    def StellarBounds(ax,fs=30):
        ...
        # Stellar physics constraints
        # SN1987A cooling nucleon-nucleon Bremsstrahlung arXiv:[1906.11844]
        SN = loadtxt(os.path.join(rootdir, "limit_data/AxionProton/SN1987A.txt"))
        SN[:,1] *= 2*AxionNeutron.m_n
        plt.fill_between(SN[:,0],SN[:,1],y2=y2,edgecolor=None,facecolor='#067034',zorder=0.02)
        plt.plot(SN[:,0],SN[:,1],'k-',alpha=1,lw=2.5,zorder=0.02)
        ...
        # Cooling of HESS J1731-347 arXiv:[1806.07991]
        SN = loadtxt(os.path.join(rootdir, "limit_data/AxionProton/NeutronStars.txt"))
        SN[:,1] *= 2*AxionNeutron.m_n
        plt.fill_between(SN[:,0],SN[:,1],y2=y2,edgecolor=None,facecolor='DarkGreen',zorder=0.01)
        plt.plot(SN[:,0],SN[:,1],'k-',alpha=1,lw=2.5,zorder=0.01)
...
class AxionEDM():
    ...
    def CASPEr(ax,text_pos=[130e-9,1e-3],col='crimson',text_col='w',fs=20,zorder=30,projection=False,text_on=True):
        dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionEDM/CASPEr-electric.txt'))
        ...
        if projection:
            dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionEDM/Projections/CASPEr-electric-PhaseI.txt'))
            plt.plot(dat[:,0],dat[:,1],'--',color=col,zorder=-10,lw=3)
            plt.fill_between(dat[:,0],dat[:,1],y2=1e0,color=col,lw=4,alpha=0.05,zorder=-10)

            dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionEDM/Projections/CASPEr-electric-PhaseII.txt'))
            plt.plot(dat[:,0],dat[:,1],'--',color=col,zorder=-10,lw=3)
            plt.fill_between(dat[:,0],dat[:,1],y2=1e0,color=col,lw=4,alpha=0.05,zorder=-10)

            dat = loadtxt(os.path.join(rootdir, 'limit_data/AxionEDM/Projections/CASPEr-electric-PhaseIII.txt'))
            plt.plot(dat[:,0],dat[:,1],'--',color=col,zorder=-10,lw=3)
            plt.fill_between(dat[:,0],dat[:,1],y2=1e0,color=col,lw=4,alpha=0.05,zorder=-10)
            if text_on:
...
class Axion_fa():
    ...
    def NeutronStars(ax,text_pos=[0.5e-3,1.1e-12],col='#1f6ff0',text_col='#1f6ff0',text_rot=43.5,fs=29,zorder=-5):
        dat = loadtxt(os.path.join(rootdir, 'limit_data/fa/Projections/NeutronStars.txt'))
    ...
    def Inspirals(ax,text_pos=[1e-16,2e-14],col='#b9befa',text_col='#b9befa',text_rot=0,fs=23,zorder=-2):
        dat = loadtxt(os.path.join(rootdir, 'limit_data/fa/Projections/NSBH-Inspiral.txt'))
        plt.plot(dat[:,0],dat[:,1],'--',color=col,lw=3,alpha=1,zorder=zorder)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e-99,color=col,zorder=zorder,alpha=0.2)

        dat = loadtxt(os.path.join(rootdir, 'limit_data/fa/Projections/NSNS-Inspiral.txt'))
        plt.plot(dat[:,0],dat[:,1],'--',color=col,lw=3,alpha=1,zorder=zorder)
        plt.fill_between(dat[:,0],dat[:,1],y2=1e-99,color=col,zorder=zorder,alpha=0.2)
    ...
    def StorageRingEDM(ax,text_pos=[1e-11,1.5e-13],col='crimson',alpha=0.4,zorder=-2,rot=41,fs=20):
        dat = loadtxt(os.path.join(rootdir, 'limit_data/fa/Projections/StorageRingEDM.txt'))
    ...
    def CASPEr(ax,text_pos=[9e-11,4e-19],col='crimson',alpha=0.1,zorder=-2,rot=57,fs=23):
        dat = loadtxt(os.path.join(rootdir, 'limit_data/fa/Projections/CASPEr-electric-PhaseIII.txt'))
