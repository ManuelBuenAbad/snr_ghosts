...
# if args.slice == "r-tsig":
#     args.S0 = None
#     args.t_extra = 0.
# if args.slice == "r-tex":
#     args.t_sig = 1.e4  # saturate the max of adia phase
...
if args.slice == "Lpk-tpk":
    ...
    # this is mainly to turn off no_dist but still able to cause an exception if not updated again
    snr.set_distance(0)
